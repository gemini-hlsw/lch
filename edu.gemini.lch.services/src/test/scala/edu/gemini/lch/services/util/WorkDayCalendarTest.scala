...
class WorkDayCalendarTest {
  ...
  private val thisMonday = new DateTime(2012,12,17,0,0) // Dec 17 2012 is a Monday
  private val thisTueday = new DateTime(2012,12,18,0,0) // Dec 18 2012 is a Tuesday
  private val thisThuday = new DateTime(2012,12,20,0,0)
  private val thisFriday = new DateTime(2012,12,21,0,0)
  private val thisSatday = new DateTime(2012,12,22,0,0)
  private val thisSunday = new DateTime(2012,12,23,0,0)
  private val nextMonday = new DateTime(2012,12,24,0,0) // Dec 24 2012 is a Monday
  private val nextTueday = new DateTime(2012,12,25,0,0) // Dec 25 2012 is a Tuesday and a Holiday
  private val nextFriday = new DateTime(2012,12,28,0,0)
  ...
  @Transactional(readOnly = true)
  def doesItAll : Unit = {
    assertEquals(3, calendar.workDaysBetween(new DateTime(2012,11,21,0,0), new DateTime(2012,11,27,0,0))) // {Wed, Fri, Mon}
  }
  ...
  def doesItAllWithTimes : Unit = {
    assertEquals(3, calendar.workDaysBetween(new DateTime(2012,11,21,9,0), new DateTime(2012,11,27,18,0))) // {Wed, Fri, Mon}
  }
